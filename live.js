    ...
    checkForChanges: function () {
      for (var url in resources) {
        ...
        Live.getHead(url, function (url, newInfo) {
          if (!newInfo) {
            // Remove the resource so Live.js stops trying to fetch it
      ...
      switch (type.toLowerCase()) {
        ...
        case "text/css":
          var link = currentLinkElements[url],
            ...
            next = link ? link.nextSibling : null,
    ...
    getHead: function (url, callback) {
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState == 4) {
          ...
          // Check for a non-2xx status code or a failed request
          ...
          if (xhr.status != 304) {
            ...
            for (var h in headers) {
              ...
              // adjust the simple Etag variant to match on its significdant part
